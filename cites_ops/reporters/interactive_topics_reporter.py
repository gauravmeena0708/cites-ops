...
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font:14px/1.45 "Segoe UI",Aptos,Arial,sans-serif}.top{background:linear-gradient(120deg,var(--navy),#183b5a);color:#fff;padding:25px max(18px,calc((100vw - 1480px)/2))}.top h1{font-size:27px;margin:4px 0}.eyebrow{color:#a9c4d8;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.top-meta{display:flex;gap:14px;flex-wrap:wrap;color:#d5e2ec;font-size:12px}.wrap{max-width:1480px;margin:auto;padding:22px}.notice{background:#fff4d7;border:1px solid #edcf81;border-left:4px solid var(--amber);border-radius:9px;padding:11px 14px;margin-bottom:16px;color:#654408}.kpis{display:grid;grid-template-columns:repeat(5,minmax(150px,1fr));gap:11px;margin-bottom:16px}.kpi{background:#fff;border:1px solid var(--line);border-radius:10px;padding:14px 16px;box-shadow:0 4px 16px rgba(11,31,51,.05)}.kpi span{display:block;color:var(--muted);font-size:11px;font-weight:700}.kpi strong{display:block;font-size:25px;margin-top:4px}.kpi.accent{background:var(--teal);color:#fff;border-color:var(--teal)}.kpi.accent span{color:#dcf8f2}.panel{background:#fff;border:1px solid var(--line);border-radius:11px;box-shadow:var(--shadow);padding:17px}.panel-head{display:flex;justify-content:space-between;align-items:flex-end;gap:15px;margin-bottom:13px}.panel-head h2{font-size:19px;margin:0 0 3px}.panel-head p{margin:0;color:var(--muted);font-size:12px}.controls{display:flex;gap:8px;flex-wrap:wrap}.controls input,.controls select,.modal-tools input,.modal-tools select{border:1px solid #bdcbd6;background:#fff;border-radius:8px;padding:9px 10px;color:var(--ink);font:inherit}.controls input{min-width:275px}.table-scroll{overflow:auto;max-height:70vh;border:1px solid var(--line);border-radius:8px}table{width:100%;border-collapse:collapse;min-width:1110px}th,td{padding:10px 11px;border-bottom:1px solid #e5ebf0;text-align:left;vertical-align:top}th{position:sticky;top:0;z-index:3;background:var(--navy);color:#fff;font-size:10px;text-transform:uppercase;letter-spacing:.04em;white-space:nowrap}th.num,td.num{text-align:right}.topic-row{cursor:pointer}.topic-row:hover,.topic-row:focus{background:#edf3ff;outline:none}.topic-name{font-weight:800;color:#214dbf}.topic-name small{display:block;color:var(--muted);font-size:10px;font-weight:500;margin-top:3px}.description{color:var(--muted);min-width:310px}.overall-row{position:sticky;top:37px;z-index:2;background:#e7edf4;font-weight:800}.route{display:inline-block;border-radius:15px;padding:3px 7px;margin:1px;font-size:10px;font-style:normal;font-weight:800;white-space:nowrap}.route-epfo{background:#e6eeff;color:#2454d9}.route-cdac{background:#dcf4ed;color:#116c5c}.route-field{background:#fff0cf;color:#895900}.route-other{background:#e9eef3;color:#50616e}.up{color:var(--red);font-weight:800}.down{color:var(--green);font-weight:800}.empty{text-align:center;color:var(--muted);padding:30px}.footer{color:var(--muted);font-size:11px;text-align:center;padding:18px}.modal{position:fixed;inset:0;z-index:30;display:none;background:rgba(6,19,31,.67);padding:18px}.modal.open{display:flex}.modal-card{margin:auto;background:#fff;width:min(1420px,100%);height:min(92vh,940px);border-radius:12px;box-shadow:0 24px 70px rgba(0,0,0,.3);display:grid;grid-template-rows:auto auto 1fr auto;overflow:hidden}.modal-head{background:var(--navy);color:#fff;padding:16px 18px;display:flex;justify-content:space-between;gap:14px}.modal-head h2{margin:0;font-size:21px}.modal-head p{margin:3px 0 0;color:#bcd0df;font-size:12px}.close{border:0;background:#fff;color:var(--navy);border-radius:8px;font-size:23px;width:38px;height:38px;cursor:pointer}.modal-tools{display:flex;gap:8px;align-items:center;flex-wrap:wrap;padding:11px 16px;border-bottom:1px solid var(--line);background:#f8fafc}.modal-tools input{min-width:300px;flex:1}.result-count{margin-left:auto;color:var(--muted);font-size:12px}.issue-scroll{overflow:auto}.issue-table{min-width:1180px}.issue-table th{top:0}.issue-table td{font-size:12px}.issue-id{font-weight:800;color:#214dbf;white-space:nowrap}.issue-summary{font-weight:700;max-width:460px}.issue-summary details{margin-top:5px;color:var(--muted);font-weight:400}.issue-summary summary{cursor:pointer;color:#516d85;font-size:11px}.issue-summary p{white-space:pre-wrap;margin:6px 0 0;max-height:180px;overflow:auto}.status{display:inline-block;border-radius:13px;padding:3px 7px;font-size:10px;font-weight:800;background:#e9eef3}.status-open{background:#fff0cf;color:#895900}.status-closed{background:#dcf4ed;color:#116c5c}.queue-code{display:block;margin-top:4px;font:10px Consolas,monospace;overflow-wrap:anywhere}.modal-foot{display:flex;align-items:center;justify-content:center;gap:10px;padding:10px;border-top:1px solid var(--line);background:#f8fafc}.button{border:0;border-radius:8px;background:var(--blue);color:#fff;padding:8px 13px;font:inherit;font-weight:700;cursor:pointer}.button:disabled{opacity:.35;cursor:not-allowed}.page-label{color:var(--muted);font-size:12px;min-width:150px;text-align:center}
...
.hierarchy-panel{margin-top:18px}.hierarchy-tools{display:flex;gap:8px;flex-wrap:wrap}.tree{border:1px solid var(--line);border-radius:9px;overflow:hidden}.tree details{border-bottom:1px solid var(--line)}.tree details:last-child{border-bottom:0}.tree summary{cursor:pointer;display:grid;grid-template-columns:minmax(280px,1fr) auto;gap:14px;align-items:center;padding:11px 13px;background:#fff}.tree summary:hover{background:#f4f8ff}.tree-children{margin-left:22px;border-left:2px solid #dce6ee}.tree-level{display:inline-block;min-width:108px;color:var(--muted);font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.tree-name{font-weight:750}.tree-metrics{display:flex;gap:12px;align-items:center;white-space:nowrap;font-size:11px;color:var(--muted)}.tree-metrics b{color:var(--ink);font-size:12px}.tree-topic{appearance:none;border:0;border-bottom:1px solid var(--line);background:#fbfdff;color:var(--ink);cursor:pointer;width:100%;padding:10px 13px 10px 28px;display:grid;grid-template-columns:minmax(300px,1fr) auto;gap:14px;text-align:left;align-items:center}.tree-topic:last-child{border-bottom:0}.tree-topic:hover,.tree-topic:focus{background:#edf3ff}.tree-topic-name{font-weight:800;color:#214dbf}.tree-topic small{display:block;color:var(--muted);font-weight:400;margin-top:2px}.tree-empty{padding:22px;color:var(--muted);text-align:center}
</style>
</head>
<body>
<header class="top">
